...
const Banner = () => {
    return (
        <div className="mb-7">
            <Carousel>
                <div>
                    <img className="rounded-2xl max-h-[800px]" src={img01} />
                </div>
                <div>
                ...
                <div>
                    <img className="rounded-2xl max-h-[800px]" src={img05} />
                </div>
                <div>
                    <img className="rounded-2xl max-h-[800px]" src={img06} />
                </div>
                <div>
                    <img className="rounded-2xl max-h-[800px]" src={img07} />
                </div>
            </Carousel>
        </div>
    );
